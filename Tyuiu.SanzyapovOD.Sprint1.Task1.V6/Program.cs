using Tyuiu.SanzyapovOD.Sprint1.Task1.V6.Lib;
namespace Tyuiu.SanzyapovOD.Sprint1.Task1.V6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Написать программу, которая вычисляет выражение (x + y) / (3 * y)       *");
